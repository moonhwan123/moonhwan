...
public class MemberDAO {
	...
	public boolean memberInsert(MemberVO vo) {
			...
			String query = "insert into tbl_member(idx,name,userid,passwd,gubun,zipcode,addr1,addr2,tel,email,job,favorite,intro,"
					+ " emailchecked,emailhash)"
					+ " values(tbl_member_seq_idx.nextval,?,?,?,?,?,?,?,?,?,?,?,?,'0',?)";
			boolean flag = false;
			...
			try {
				...
				pstmt.setString(13, SHA256.getSHA256(vo.getEmail()));
				pstmt.executeUpdate();
				flag = true;
	...
	public boolean getUserEmailChecked(String userID) {
		...
		String SQL = "SELECT EmailChecked FROM tbl_member WHERE userid = ?";
	...
	public String getUserEmail(String userID) {
		...
		String SQL = "SELECT email FROM tbl_member WHERE userid = ?";
