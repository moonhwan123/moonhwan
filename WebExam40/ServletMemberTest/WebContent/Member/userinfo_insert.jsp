...
<script>
	...
	function post_check(){
		window.open("post_check","post_check form","width=400 height=300");
		//경로,이름,설정
			...
			<table cellpadding=0 cellspacing=0 border=0 width=650 align=center>       
				<tr>
                 ...
                 6~12자 이내의 영문이나 숫자만 가능합니다.
                  		...
                  		<td>
      									<a href="#" onClick="post_check()"><img src="Member/img/u_bt07.gif" hspace=2 border=0 name=img2 align=absmiddle></a>
 											</td>
										</tr>
									</table>
								</td>
