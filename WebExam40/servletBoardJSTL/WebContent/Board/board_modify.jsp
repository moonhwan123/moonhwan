...
<script>
 ...
 <tr>
   ...
   <td width="80%" valign="top">&nbsp;<br>
     ...
     <form name="modify" method="post" action="board_modify">
      ...
      <table border="0">
       ...
       <tr>
         ...
         <td><font size="2" face="돋움">비밀번호</font></td>
          <td><input type="password" size="10" name="pass" value="${vo.getPass() }" >
        ...
        <tr>
          ...
          <a href="Board/Board_list"><img src="Board/img/cancle.gif" border=0></a></td></tr>
      </table>
      </form>
    </td></tr>
  </table>
