...
<div class="sr-only">
	...
	<div class="top_navigation">
		...
		<header class="header">
			...
			<div class="gnb_group">
				<h1 class="logo">CHOI MOON HWAN COMPANY</h1>
				<nav class="gnb">
					<ul class="nav_1depth">
						<li><a>기업소개</a>
							<ul class="nav_2depth">
								<li><a href="../about/gratings.jsp">인사말</a></li>
								<li><a href="../about/history.jsp">연혁 및 비젼 </a></li>
								<li><a href="../photo_list">갤러리</a></li>
						...
						<li><a>포트폴리오</a>
							<ul class="nav_2depth">
								<li><a href="../portfolio_list">포트폴리오</a></li>
							</ul>
						</li>
						...
						<li><a>커뮤니티</a>
							<ul class="nav_2depth">
								...
								<li><a href="../qna/qa.jsp">질문과답변</a></li>
								<li><a href="../faq_list">FAQ</a></li>
								<li><a href="../pds/pds.jsp">자료실</a></li>
								<li><a href="../adm/admin.jsp">관리자</a></li>
							</ul>
						</li>
					</ul>
				</nav>
