 ...
 <body topmargin="0" leftmargin="0">
   <table border="0" width="800">
     <tr>
      ...
      <font size="2">
       <!-- 목록보기 -->
       <a href="Guest?command=guest_list"><img src="./img/list-2.gif" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
       <!-- 수정하기 -->
        <a href="Guest?command=guest_modify&idx=${vo.idx}&page=${page }"><img src="./img/edit.gif" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
       <!-- 삭제하기 -->
       <a href="Guest?command=guest_delete&idx=${vo.idx}"><img src="./img/del.gif" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
      </font>
    </td>
  </tr>
  </table>
