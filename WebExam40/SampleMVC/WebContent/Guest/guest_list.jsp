  ...
  <tr>
    ...
    <table border="0" cellspacing="1" width="100%" align="center">
      ...
      <tr>
		...
		<font size="2" face="고딕">전체 : ${listcount}</b>건 - ${page}/ ${totpage}</font></td></tr>
 	   <tr bgcolor="e3e9ff">
        ...
        <font face="돋움" size="2" color="#000000">
		      <a class="list" href = "Guest?command=guest_view&idx=${guest.idx }&page=${page}"> ${guest.subject }</a></td>
        ...
        <table width="700" border="0" cellspacing="0" cellpadding="5">
          <tr>&nbsp;</tr><tr>
			...
			<tr align=right><td colspan="5">
				<a href="Guest?command=guest_write"><img src="./img/write.gif" border="0"></a>
			</td>
			</tr>
		</table>
		</div>
