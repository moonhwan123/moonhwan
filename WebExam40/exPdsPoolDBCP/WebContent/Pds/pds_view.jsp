...
<html>
 ...
 <link rel="stylesheet" type="text/css" href="/stylesheet.css">
   <style type="text/css">
    ...
    <script>
 	function board_del(){
 		url = "pds_delete?idx=${vo.idx}&page=${page}";
...
<!--  로그인 폼 추가 -->
  ...
  <p align="center">
  <font size="2">
  <a href="pds_modify?idx=${vo.idx}"><img src="./img/edit-1.gif" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="pds_delete?idx=${vo.idx}"><img src="./img/del.gif" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
