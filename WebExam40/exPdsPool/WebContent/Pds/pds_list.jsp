...
<!--  다음에 추가할 부분 -->
	  ...
	  <c:forEach items="${list}" var="pds">
	      <tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
	        <td align="center" height="25">
	        		<font face="돋움" size="2" color="#000000">${listcount }
	        		</font></td>
					<td align="left" height="20">&nbsp;<font face="돋움" size="2">
					<a class="list" href="pds_view?idx=${pds.idx }&page=${page}">${pds.subject }</a></font></td>
	        		<td align="center" height="20">
	        		<a href="upload/${pds.filename}" download><font face="돋움" size="2">${pds.filename }</td></a>
   ...
   <tr>
     ...
     <form name="board" method ="post" action="pds_list">
      <tr>
      <td><center>
      <font color="#004080" size="4" face="Courier New"><strong>Search&nbsp;</strong></font>
		...
		&nbsp;&nbsp;<a href="#" onClick="kensaku()"><input type="image" src="./img/search2.gif" align="middle"></a>
	   </td>
	   </tr>
	   </table>
    </table>
