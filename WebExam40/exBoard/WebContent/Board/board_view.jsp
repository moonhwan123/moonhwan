         ...
         <tr>
           <td class="content">
             <p align="right"><font size="2" face="돋움">
              <a class="list" href="mailto:ein1027@nate.com"><%= rs.getString("name") %></a> / <font size="2" face="돋움">
              <%= rs.getString("regdate").substring(0,11) %> / <%= rs.getInt("readcnt") %></font>
             <p>
             <%= rs.getString("contents") %><p><!--contents의 내용을 <BR>태그로 처리-->
           </td>
         </tr>
       </table>
