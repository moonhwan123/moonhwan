...
public class ReDAO {
	...
	// [1] 도서 대출 예약 등록
	public int reInsert(int lentno, String custname, String phone, int bookno, String outdate, String indate,String status) {
		String query = "insert INTO reservation (lentno,custname,phone,bookno,outdate,indate,status) "
				+ "VALUES (?,?,?,?,?,?,?)";
		int row = 0;
	...
	public int reReturn(String strToday,int lentno) {
		String query = "update reservation set indate = ? , status = '2' where lentno = ?";
		int row = 0;
